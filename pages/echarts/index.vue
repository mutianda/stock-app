<template>
	<view class="canvasView">
		<view class="canvasView">
		<mpvue-echarts ref="barChart" :echarts="echarts" @onInit="initklineChart" class="charts1-box" />
		 <mpvue-echarts ref="klineChart" :echarts="echarts" @onInit="initklineChart" class="charts-box" />
